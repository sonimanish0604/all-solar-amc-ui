...
This directory stores repository-specific documentation for mobile and UI implementation.

Suggested topics for this repo:

- mobile architecture decisions
- FlutterFlow export/import workflow
- Firebase setup for mobile clients
- API integration notes against `neilsolaramc`
